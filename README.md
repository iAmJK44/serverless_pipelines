...
|:--------|:--------|:--------:|:--------:|
| **General**  ||     
|    [*Lithops Benchmarks*](#1-lithops-flops)      |      Analyze Lithops computation in FLOPS.     |    Autogenerated    |    NumPy array    |
|    [*Object Storage Test*](#2-object-storage)      |      Measure the bandwidth from FaaS Service.     |    Autogenerated    |    Bytes    |
...
## 1. [Lithops FLOPS](https://github.com/lithops-cloud/applications/tree/master/benchmarks/flops))
...
## 2. [Object Storage](https://github.com/lithops-cloud/applications/tree/master/benchmarks/object_storage)
...
## 7. [METASPACE](https://github.com/metaspace2020/Lithops-METASPACE)
