...
| Benchmark   | Description     | Language | Stages | LOC |     Data set     |     Data format     |
|:--------|:--------|:--------:|:--------:|:--------:|:--------:|:--------:|
| **General**  |||||||
| [*FLOPS Computation Test*](#1-flops-computation-test)      | Analyze Lithops computation in FLOPS. | Python3.10 | 1 | 63 | Autogenerated    | NumPy array    |
| [*Object Storage Test*](#2-object-storage-test)      | Measure the bandwidth from FaaS Service. | Python3.10 | 2 | 286 | Autogenerated    | Bytes    |
| [*Montecarlo*](#3-montecarlo-simulations)     | Monte Carlo Methods to make computations with a big amount of random data.     | Python3.10 | 1 | 46 | Autogenerated    | NumPy array    |
| [*Mandelbrot classic*](#4-mandelbrot-classic)     | Mandelbrot set calculated on a limited space several times using the Cloudbutton toolkit.    | Python3.10 | 7 | 109 | Autogenerated    | Mandelbrot set |
| **Machine Learning**     |          |          |          |          |          |
| [*Hyperparameter tunning*](#5-hyperparameter-tunning-with-grid-search)     | Hyperparameter tuning using grid search algorithm. | Python3.10 | 1 | 111 | [Amazon customer reviews](https://www.kaggle.com/bittlingmayer/amazonreviews)      | ft.txt     |
| **Geospatial**     |          |          |          |          |          |
| [*NDVI*](#6-ndvi-calculation)     | Calculate NDVI from Object Storage images.     | Python3.10 | 2 | 1552 | Sentinel2 satellite image from the [AWS Sentinel2 open data repository](https://registry.opendata.aws/sentinel-2/)      | Cloud-Optimized GeoTIFF (COG)  |
| [*Model creation from LiDAR pre-processing*](#7-model-creation-from-lidar-pre-processing)     | Create terrain models using LiDAR partitioner. | Python3.10 | 1 | 212 | [laz files](https://www.icgc.cat/es/Descargas/Elevaciones/Datos-lidar)     | laz     |
| **Metabolomics**     |          |          |          |          |          |
| [*METASPACE metabolite annotation*](#8-metaspace-metabolite-annotation-pipeline)     | Run the METASPACE metabolite annotation pipeline on cloud resources. | Python3.8 | 16 | 2642 | [Examples of datasets and databases](https://github.com/metaspace2020/Lithops-METASPACE#example-datasets)     | imzML     |
| **Genomics**    |          |          |          |          |          |
| [*Variant Calling*](#9-variant-calling)    | Alignment of sequencing reads, stored as FASTQ files, to a reference genome, stored as a FASTA file. | Python3.10 | 9 | 4174 | Trypanosome [[Genome](https://tritrypdb.org/tritrypdb/app/downloads/Current_Release/TbruceiTREU927/fasta/data/), [SRR6052133](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR6052133&display=download)], Human [[Genome](http://hgdownload.cse.ucsc.edu/goldenpath/hg19/bigZips/), [SRR15068323](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR15068323&display=data-access) , [ERR9856489](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=ERR9856489&display=data-access)], Bos Taurus [[Genome](https://www.ensembl.org/Bos_taurus/Info/Index), [SRR934415](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR934415&display=data-access)]  | fast, fastq     |
| **Astronomics**     |          |          |          |          |          |
| [*Astronomica-interferometry*](#10-astronomica-interferometry)    | Radio interferometric data processing.     | Python3.8 | 2 | 907 | [SB205.MS SB206.MS SB207.MS SB208.MS SB209.MS SB210.MS](https://share.obspm.fr/s/ezBfciEfmSs7Tqd?path=%2FDATA)        | MS |
| **Elastic Exploration**    |          |          |          |          |          |
| [*UTS*](#11-uts)    | The Unbalanced Tree Search (UTS) benchmark.     | Java 11 | 1 | 2841 | Autogenerated    | Dynamic tree  |
| [*Mandelbrot with Mariani Silver*](#12-mandelbrot-with-mariani-silver)    | Render the Mandelbrot set using  Marian-Silver algorithm. | Java 11 | 1 | 2735 | Autogenerated    | Mandelbrot set  |
| [*Betweenness Centrality*](#13-betweenness-centrality)    | Compute the Between Centrality (BC) algorithm.  | Java 11 | 1 | 3119 | Autogenerated | Graph  |
| **Extreme Sorting**  |          |          |          |          |          |
| [*TeraSort*](#14-terasort)    | Implementation of the TeraSort benchmark built on Lithops.     | Python3.10 | 2 | 827 | [TeraGen](https://github.com/gfinol/teragen-lithops)    | ascii  |
